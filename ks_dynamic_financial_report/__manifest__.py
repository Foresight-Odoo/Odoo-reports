...
"
    ...
    'assets': {'web.assets_backend': ['ks_dynamic_financial_report/static/src/scss/ks_dynamic_financial_report.scss',
                                      ...
                                      'ks_dynamic_financial_report/static/src/js/ks_control_panel.js',
                                      'ks_dynamic_financial_report/static/src/js/ks_records_selector.js',
                                      ...
                                      'ks_dynamic_financial_report/static/src/xml/ks_control_panel.xml',
                                      'ks_dynamic_financial_report/static/src/xml/ks_records_selectors.xml',
