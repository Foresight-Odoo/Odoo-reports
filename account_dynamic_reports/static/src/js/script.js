odoo.define('account_dynamic_reports.DynamicTbMain', function(require) {
    ...
    var DynamicFrMain = AbstractAction.extend({
        ...
        plot_data: function(initial_render = true) {
            ...
            self._rpc({
                ...
                .then(function(datas) {
                    ...
                    if (initial_render) {
                        self.$('.py-control-panel')
                            .html(QWeb.render('FilterSectionFr', {
                                filter_data: self.filter_data,
                            }));
                        self.$el.find('#date_from')
                            .datepicker({
                                dateFormat: 'dd-mm-yy'
                            });
                        self.$el.find('#date_to')
                            .datepicker({
                                dateFormat: 'dd-mm-yy'
                            });
                        self.$el.find('#date_from_cmp')
                            .datepicker({
                                dateFormat: 'dd-mm-yy'
                            });
                        self.$el.find('#date_to_cmp')
                            .datepicker({
                                dateFormat: 'dd-mm-yy'
                            });
                        self.$el.find('.date_filter-multiple')
                            .select2({
                                maximumSelectionSize: 1,
                                placeholder: 'Select Date...',
                            });
                        self.$el.find('.journal-multiple')
                            .select2({
                                placeholder: 'Select Journal...',
                            });
                        self.$el.find('.analytic-tag-multiple')
                            .select2({
                                placeholder: 'Analytic Tags...',
                            });
                        self.$el.find('.analytic-multiple')
                            .select2({
                                placeholder: 'Select Analytic...',
                            });
                        self.$el.find('.extra-multiple')
                            .select2({
        ...
        view_gl: function(event) {
            ...
            var domains = {
                account_ids: [$(event.currentTarget)
                    .data('account-id')
                ],
            ...
            var journal_ids = [];
            var journal_list = $(".journal-multiple")
                .select2('data')
        ...
        update_with_filter: function(event) {
            ...
            if ($(".date_filter-multiple")
                .select2('data')
                .length === 1) {
                output.date_range = $(".date_filter-multiple")
                    .select2('data')[0].id
            }
            if ($("#date_from")
                .val()) {
            ...
            var options_list = $(".extra-multiple")
                .select2('data')
    ...
    var DynamicGlMain = AbstractAction.extend({
        ...
        plot_data: function(initial_render = true) {
            ...
            self._rpc({
                ...
                .then(function(datas) {
                    ...
                    if (initial_render) {
                        self.$('.py-control-panel')
                            .html(QWeb.render('FilterSection', {
                                filter_data: datas[0],
                            }));
                        self.$el.find('#date_from')
                            .datepicker({
                        ...
                        self.$el.find('.extra-multiple')
                            ...
                            .trigger('change');
                        self.$el.find('.account-multiple')
                            .select2({
                                placeholder: 'Select Account...',
                            });
                        self.$el.find('.account-tag-multiple')
                            .select2({
                    ...
                    self.$('.py-data-container-orig')
                        .html(QWeb.render('DataSection', {
        ...
        fetch_move_lines_by_page: function(event) {
            event.preventDefault();
            var self = this;
            var account_id = $(event.currentTarget)
                .data('account-id');
            var offset = parseInt($(event.currentTarget)
                .data('page-number')) - 1;
            var total_rows = parseInt($(event.currentTarget)
                .data('count'));
            self.loader_disable_ui();
            self.gl_lines_by_page(offset, account_id)
                .then(function(datas) {
        ...
        view_move_line: function(event) {
            ...
            redirect_to_document('account.move', $(event.currentTarget)
                .data('move-id'));
        },
        update_with_filter: function(event) {
            event.preventDefault();
            ...
            var partner_ids = [];
            var partner_list = $(".partner-multiple")
                .select2('data')
            ...
            var account_ids = [];
            var account_list = $(".account-multiple")
                .select2('data')
            ...
            var account_tag_ids = [];
            var account_tag_list = $(".account-tag-multiple")
                .select2('data')
    ...
    var DynamicPaMain = AbstractAction.extend({
        ...
        plot_data: function(initial_render = true) {
            ...
            self._rpc({
                ...
                .then(function(datas) {
                    ...
                    if (initial_render) {
                        self.$('.py-control-panel')
                            .html(QWeb.render('FilterSectionPa', {
                                filter_data: self.filter_data,
                            }));
                        self.$el.find('#as_on_date')
                            .datepicker({
                                dateFormat: 'dd-mm-yy'
                            });
                        self.$el.find('.type-multiple')
                            .select2({
                                maximumSelectionSize: 1,
                                placeholder: 'Select Account Type...',
                            });
                        self.$el.find('.partner-type-multiple')
                            .select2({
                                maximumSelectionSize: 1,
                        ...
                        self.$el.find('.partner-tag-multiple')
                            .select2({
                    ...
                    self.$('.py-data-container-orig')
                        .html(QWeb.render('DataSectionPa', {
        ...
        fetch_move_lines_by_page: function(event) {
            event.preventDefault();
            var self = this;
            var partner_id = $(event.currentTarget)
                .data('partner-id');
            var offset = parseInt($(event.currentTarget)
                .data('page-number')) - 1;
            var total_rows = parseInt($(event.currentTarget)
                .data('count'));
            self.loader_disable_ui();
            self.ageing_lines_by_page(offset, partner_id)
                .then(function(datas) {
                    var count = datas[0];
                    var offset = datas[1];
        ...
        update_with_filter: function(event) {
            ...
            output.bucket_1 = $("#bucket_1")
                .val();
            output.bucket_2 = $("#bucket_2")
                .val();
            output.bucket_3 = $("#bucket_3")
                .val();
            output.bucket_4 = $("#bucket_4")
                .val();
            output.bucket_5 = $("#bucket_5")
                .val();
            ...
            if ($(".type-multiple")
                .select2('data')
                .length === 1) {
                output.type = $(".type-multiple")
                    .select2('data')[0].id
            }
            if ($(".partner-type-multiple")
                .select2('data')
                .length === 1) {
                output.partner_type = $(".partner-type-multiple")
                    .select2('data')[0].id
            }
            var partner_ids = [];
            var partner_list = $(".partner-multiple")
            ...
            output.partner_ids = partner_ids
            var partner_tag_ids = [];
            var partner_tag_list = $(".partner-tag-multiple")
                .select2('data')
    ...
    var DynamicPlMain = AbstractAction.extend({
        ...
        plot_data: function(initial_render = true) {
            ...
            self._rpc({
                ...
                .then(function(datas) {
                    ...
                    if (initial_render) {
                        self.$('.py-control-panel')
                            .html(QWeb.render('FilterSectionPl', {
                                filter_data: datas[0],
                            }));
                        self.$el.find('#date_from')
                            .datepicker({
                        ...
                        self.$el.find('.extra-multiple')
                            ...
                            .val(['include_details', 'initial_balance', 'debit_credit'])
                            .trigger('change');
                        self.$el.find('.type-multiple')
                            .select2({
                                maximumSelectionSize: 1,
                        ...
                        self.$el.find('.reconciled-multiple')
                            .select2({
                                maximumSelectionSize: 1,
                    ...
                    self.$('.py-data-container-orig')
                        .html(QWeb.render('DataSectionPl', {
                            filter_data: datas[0],
                            account_data: datas[1],
                        }));
                    self.loader_enable_ui();
        ...
        fetch_move_lines_by_page: function(event) {
            ...
            var total_rows = parseInt($(event.currentTarget)
                .data('count'));
            self.loader_disable_ui();
            self.pl_lines_by_page(offset, account_id)
                .then(function(datas) {
                    _.each(datas[2], function(k, v) {
                        var formatOptions = {
                            currency_id: k.company_currency_id,
        ...
        update_with_filter: function(event) {
            ...
            if ($(".reconciled-multiple")
                .select2('data')
                .length === 1) {
                output.reconciled = $(".reconciled-multiple")
                    .select2('data')[0].id
            }
            var journal_ids = [];
            var journal_list = $(".journal-multiple")
            ...
            var product_ids = [];
            var product_list = $(".product-multiple")
                .select2('data')
    ...
    var DynamicTbMain = AbstractAction.extend({
        ...
        plot_data: function(initial_render = true) {
            ...
            self._rpc({
                ...
                .then(function(datas) {
                    ...
                    if (initial_render) {
                        self.$('.py-control-panel')
                            .html(QWeb.render('FilterSectionTb', {
                                filter_data: self.filter_data,
                            }));
                        self.$el.find('#date_from')
                            .datepicker({
                    ...
                    self.$('.py-data-container')
                        .html(QWeb.render('DataSectionTb', {
                            account_data: self.account_data,
        ...
        view_gl: function(event) {
            ...
            if ($(".date_filter-multiple")
                .select2('data')
                .length === 1) {
                domains.date_range = $(".date_filter-multiple")
                    .select2('data')[0].id
            }
            if ($("#date_from")
                .val()) {
    ...
    core.action_registry.add('dynamic.plg', DynamicPlMain);
